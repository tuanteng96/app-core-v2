...
const ChartWithScroll = ({ options, CrDate, data, filters, refetch }) => {
          ...
          series: [
            {
              ...
              itemStyle: {
                color: "rgb(56, 142, 60)", // ✅ Màu nền của cột Ngực trái
              },
            },
            {
              name: "Ngực phải",
              ...
              itemStyle: {
                color: "rgb(211, 47, 47)", // ✅ Màu nền của cột Ngực trái
              },
            },
          ],
        },
          ...
          >
            {!isDetail && (
              <div className="pt-20px">
                ...
                />
                <div
                  className="text-center mt-20px px-10px"
